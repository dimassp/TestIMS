...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.showCalendarEl === "boolean")
            this.showCalendarEl = options.showCalendarEl;
        ...
        renderCalendar: function (side) {
            ...
            var arrow =
                this.locale.direction == "ltr"
                    ? { left: "arrow-left32", right: "arrow-right32" }
                    : { left: "arrow-right32", right: "arrow-left32" };
            if (this.showCalendarEl) {
            ...
            if (
                ...
                html +=
                    '<th class="prev available"><i class="icon-' +
                    arrow.left +
                    '"></i></th>';
            } else {
                html += "<th></th>";
            ...
            if (this.showDropdowns) {
                ...
                var monthHtml =
                    '<select class="monthselect form-control input-sm">';
                for (var m = 0; m < 12; m++) {
                    if (
                ...
                var yearHtml =
                    '<select class="yearselect form-control input-sm">';
            ...
            if (
                ...
                html +=
                    '<th class="next available"><i class="icon-' +
                    arrow.right +
                    '"></i></th>';
            } else {
                html += "<th></th>";
